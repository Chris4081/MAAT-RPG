...
def start_classic():
    ...
    if PluginManager is not None:
        try:
            ...
            pm = PluginManager([app_plugin_root, shared_plugin_root], config_path=os.path.join(APP_ROOT,'plugin_config.json'))
            pm.load_plugins()
    ...
    while True:
        try:
            ...
            print(exc.notice(get_language(('de', 'en'))))
