...
from shared.core.maat_paths import get_data_dir, get_default_app_support_dir, get_profiles_dir
...
def reset_startup_selection():
    ...
    candidate_roots = [get_default_app_support_dir()]
    ...
    candidate_paths = [MODEL_OVERRIDE_PATH, PERF_OVERRIDE_PATH]
    for root in candidate_roots:
        data_dir = root / "data"
        candidate_paths.append(str(data_dir / "model_override.txt"))
        candidate_paths.append(str(data_dir / "perf_override.json"))
