...
MAAT-RPG currently has **experimental Windows support**.
...
- `ffmpeg` / `ffplay` for terminal sound effects and optional user-supplied music
...
- The source edition contains no background music. Terminal sound playback uses `ffplay` when available
